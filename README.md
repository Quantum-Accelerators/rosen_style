...
Both styles use constrained layout to arrange axes and labels within the figure. Saved figures retain their configured dimensions without tight bounding-box cropping.
