...
The first question to address is: why? Why use a rosen_style repository like this? Why make a Python package at all, as opposed to writing custom scripts or Jupyter Notebooks?
...
This is by no means the only rosen_style of its kind. Some alternatives include:
...
- [python-package-rosen_style](https://github.com/microsoft/python-package-rosen_style)

... and many more.

Feel free to use them if you wish! This rosen_style repository exists because we are all opinionated people, and this rosen_style focuses on things that I value most. But the point is to just use something that works well for you.
